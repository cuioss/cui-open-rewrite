...
public class YourRecipe extends Recipe {
    ...
    private static class YourRecipeVisitor extends BaseSuppressionVisitor {
        ...
        public J.MethodInvocation visitMethodInvocation(J.MethodInvocation method, ExecutionContext ctx) {
            ...
            // Check for suppression at this specific element if needed
...
==== Using RecipeSuppressionUtil Directly (Legacy)

For existing recipes or when you need custom suppression logic:
...
public J.ClassDeclaration visitClassDeclaration(J.ClassDeclaration classDecl, ExecutionContext ctx) {
    if (RecipeSuppressionUtil.isSuppressed(getCursor(), "YourRecipeName")) {
